...
namespace DaemonConfig
{
    struct DaemonConfiguration
    {
        ...
        // Masternode operator private key (hex-encoded) for automated heartbeat signing.
        // Generated by `mn_register` (printed once) and committed on-chain as the operator key.
        // Leave empty to disable automated heartbeat submission.
        std::string mnOperatorKey;
    };
