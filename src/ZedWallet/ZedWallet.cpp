...
// Copyright (c) 2018, The Wrkz Developers
// 
         ...
         Config &config)
{
    ...
    do
    {
        std::cout << InformationMsg("Wrkzd v"
    ...
    {
        std::cout << WarningMsg("It looks like Wrkzd isn't open!")
                  << std::endl << std::endl
                  << WarningMsg("Ensure Wrkzd is open and has finished "
                                "initializing.")
                  << std::endl
                  << WarningMsg("If it's still not working, try restarting "
                                "Wrkzd. The daemon sometimes gets stuck.") 
                  << std::endl
                  << WarningMsg("Alternatively, perhaps Wrkzd can't "
