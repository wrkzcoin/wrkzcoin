...
// wrkz: this made error during compile VS 2017. Already include in Open.h
...
void viewWalletMsg()
{
    std::cout << InformationMsg("Please remember that when using a view wallet "
              ...
              << std::endl << "This means if you received 100 Wrkz and then "
              << "sent 50 Wrkz, your balance would appear to still be 100 "
              << "Wrkz." << std::endl
...
void connectingMsg()
{
    std::cout << std::endl << "Making initial contact with Wrkzd."
              << std::endl
