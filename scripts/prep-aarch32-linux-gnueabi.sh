...
export RANLIB=$TOOLCHAIN_DIR/gcc-arm-8.2-2018.08-x86_64-arm-linux-gnueabi/bin/arm-linux-gnueabi-gcc-ranlib
...
if [ ! -f $TOOLCHAIN_DIR/boost_1_68_0/stage/lib/libboost_system.a ]; then
  ...
  echo "Complete"
  echo "using gcc : arm : ${TOOLCHAIN_DIR}/gcc-arm-8.2-2018.08-x86_64-arm-linux-gnueabi/bin/arm-linux-gnueabi-g++ ; " >> tools/build/boost-build.jam
